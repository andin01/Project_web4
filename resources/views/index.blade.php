  ...
  <div class="container-fluid bg-primary px-0 px-md-5 mb-5">
    <div class="row align-items-center px-3">
      <div class="col-lg-6 text-center text-lg-left">
        <h4 class="text-white mb-4 mt-5 mt-lg-0">Sistem Informasi</h4>
        <h1 class="display-3 font-weight-bold text-white">
          SMKN 7 JEMBER
        </h1>
        <p class="text-white mb-4">
        Bergabunglah menjadi bagian dari keluarga smektuber
        </p>
        <a href="" class="btn btn-secondary mt-1 py-3 px-5">Cek PPDB</a>
      </div>
  ...
  <div class="container-fluid py-5">
    <div class="container">
      <div class="row align-items-center">
        <div class="col-lg-5">
          <img class="img-fluid rounded mb-5 mb-lg-0" src="img/rizqi.jpg" alt="" />
        </div>
        <div class="col-lg-7">
